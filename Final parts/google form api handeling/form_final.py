...
def add_questions(service, form_id):
  requests = {
    "requests": [
      ...
      {
        "createItem": {
          "title": "Enter your birth date",  # Correct field name
          "type": "DATE"                   # Correct field name
        }
      },
      {
        "createItem": {
          "title": "Enter a short answer",  # Correct field name
...
def main():
    ...
    responses = get_form_responses(service_read_responses, "1or3QGLyvZmATDuriaKa2deGpX7jsrQCp19FBTdoa9cw")
